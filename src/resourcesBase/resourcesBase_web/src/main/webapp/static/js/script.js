    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.flag) {
                ...
                $("#likeCount-" + articleId).html(data.data);
            }
        },
        error: function () {
            //alert("获取数据出错!");
