...
<rapid:override name="header-style">
    <rapid:override name="header-style">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/highlight.css">
        <style>
            .entry-title {
                background: #f8f8f8;
            }
...
<rapid:override name="left">
    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            <article class="post" id="articleDetail" data-id="${article.id}">
                        ...
                        <div class="social-main">
                            <span class="like">
                                <a href="javascript:;" data-action="ding" data-id="1" title="点赞"
                                   class="favorite" onclick="increaseLikeCount(${article.id})">
                                    <i class="fa fa-thumbs-up"></i>赞
                                    <i class="count" id="count-${article.id}">${article.articleLikeCount}</i>
                                </a>
                            </span>
                            <div class="shang-p">
                            ...
                            <c:if test="${sessionScope.user!=null}">
                                <li class="edit-link">
                                    <a target="_blank" class="post-edit-link"
                                       href="/admin/article/edit/${article.id}">编辑</a>
                                </li>
                            </c:if>
                            <li class="comment">
